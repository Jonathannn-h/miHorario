  ...
  return (
    <div className={`w-full border-r last:border-r-0 transition-all duration-200 ${isActive ? (isDark ? 'border-sky-400/60 bg-slate-900/95 shadow-[inset_0_0_0_1px_rgba(56,189,248,0.35)]' : 'border-sky-400/60 bg-sky-50/95 shadow-[inset_0_0_0_1px_rgba(56,189,248,0.35)]') : (isDark ? 'border-slate-800/80 bg-slate-950/80' : 'border-slate-200 bg-slate-50/90')}`}>
      ...
      <div
        ...
        className={`min-h-[220px] space-y-3 px-3 py-4 transition-colors duration-200 ${isActive ? (isDark ? 'bg-sky-500/10' : 'bg-sky-100/70') : ''}`}
      >
